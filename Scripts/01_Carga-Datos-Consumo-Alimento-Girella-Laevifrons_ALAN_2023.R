...
# En la sección #1 debemos descargar e instalar el paquete de R que nos permitirá leer archivos ".csv"
...
# Cada script de carga de datos corresponde a sólo 1 dataset. El presente corresponde a la lectura de datos de Crecimiento.
